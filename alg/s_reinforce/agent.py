...
class Agent(nn.Module):
    """Neural network-based agent for S-REINFORCE, supporting both discrete and continuous action spaces.
    Identical architecture to PPO agent; S-REINFORCE logic lives in core.py.
