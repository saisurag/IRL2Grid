...
def get_alg_args() -> Namespace:
    ...
    parser.add_argument("--total-timesteps", type=int, default=80000000, help="Total timesteps for the experiment")
    ...
    parser.add_argument("--cost-threshold", type=float, default=1.0, help="Cost threshold")
    parser.add_argument("--k", type=float, default=20, help="Fixed penalty value")
